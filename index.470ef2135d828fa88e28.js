...
/* harmony default export */ __webpack_exports__["default"] = ({
  render: function render(template, model, id) {
    document.getElementById(id).innerHTML = template(model);
  },
  addMessage: function addMessage(template, model, id, tag) {
    var element = document.createElement(tag);
    console.log(model); // TODO пофиксить вложенность

    element.innerHTML = template(model);
    document.getElementById(id).appendChild(element);
  },
  setProfileName: function setProfileName(model, id) {
    var p = document.getElementById(id);
    var avatar = document.getElementById('avatar');
    avatar.src = model.image;
    p.innerHTML = model.name;
  },
  displayElement: function displayElement(id, display) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li>\n    <div id=\"photo\" class=\"photo\"><img src=\""
    ...
    + "</span>\n        <span>"
    + alias2(((helper = (helper = helpers.message || (depth0 != null ? depth0.message : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"message","hash":{},"data":data}) : helper)))
    + "</span>\n    </div>\n</li>\n";
...
/* harmony import */ var _client_View_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./client/View/style.css */ "./src/client/View/style.css");
/* harmony import */ var _client_View_style_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_client_View_style_css__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! socket.io-client */ "./node_modules/socket.io-client/lib/index.js");
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(socket_io_client__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _client_View_View__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./client/View/View */ "./src/client/View/View.js");
/* harmony import */ var _client_messages_hbs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./client/messages.hbs */ "./src/client/messages.hbs");
/* harmony import */ var _client_messages_hbs__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_client_messages_hbs__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _client_userList_hbs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./client/userList.hbs */ "./src/client/userList.hbs");
/* harmony import */ var _client_userList_hbs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_client_userList_hbs__WEBPACK_IMPORTED_MODULE_5__);
...
var photo = document.querySelector('#photoInput');
var dropArea = document.querySelector('#target');
var uploadBtn = document.querySelector('#upload');
var cancel = document.querySelector('#cancel');
var avatar = document.getElementById('avatar');
var fileReader = new FileReader();
var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_2___default.a.connect('https://chat-ls.herokuapp.com');

var getCookies = function getCookies() {
  var c = document.cookie;
  return c ? c.split('; ').reduce(function (prev, current) {
    var _current$split = current.split('='),
        _current$split2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_current$split, 2),
...
var authUser = function authUser() {
  ...
  return fetch('https://chat-ls.herokuapp.com/auth', {
    method: 'POST',
    headers: myHeaders,
    body: JSON.stringify({
...
login.addEventListener('click', function (e) {
  ...
  auth.then(function (auth) {
    _client_View_View__WEBPACK_IMPORTED_MODULE_3__["default"].setProfileName(auth, 'pname');
    document.cookie = "_id=".concat(auth._id);
  });
  auth.then(function (auth) {
    return socket.emit('authorization', auth);
  });
  _client_View_View__WEBPACK_IMPORTED_MODULE_3__["default"].displayElement('authorization', 'none');
  socket.on('authorization', function (messages, users) {
    _client_View_View__WEBPACK_IMPORTED_MODULE_3__["default"].render(_client_userList_hbs__WEBPACK_IMPORTED_MODULE_5___default.a, users, 'users-list');
    _client_View_View__WEBPACK_IMPORTED_MODULE_3__["default"].render(_client_messages_hbs__WEBPACK_IMPORTED_MODULE_4___default.a, messages, 'messages');
  });
  ...
  socket.on('message', function (messages) {
    _client_View_View__WEBPACK_IMPORTED_MODULE_3__["default"].addMessage(_client_messages_hbs__WEBPACK_IMPORTED_MODULE_4___default.a, messages, 'messages', 'li');
  });
  ...
  cancel.addEventListener('click', function () {
    _client_View_View__WEBPACK_IMPORTED_MODULE_3__["default"].displayElement('upload-photo', 'none');
  });
  socket.on('updatePhoto', function (messages) {
    _client_View_View__WEBPACK_IMPORTED_MODULE_3__["default"].render(_client_messages_hbs__WEBPACK_IMPORTED_MODULE_4___default.a, messages, 'messages', 'li');
  });
  photo.addEventListener('click', function () {
    _client_View_View__WEBPACK_IMPORTED_MODULE_3__["default"].displayElement('upload-photo', 'block');
  });
...
/******/ });
//# sourceMappingURL=index.470ef2135d828fa88e28.js.map